...
namespace Vcs.SSIS
{
    [
        ...
        (
            DisplayName = "VRC Row Count"
            , Description = "Counts rows of different types (Select, Insert, Update, Delete, Intermediate, Error, Truncate), and logs this via the Vcs custom log provider."
            , ComponentType = 0
            , IconResource = "Vcs.SSIS.RowCount.ico"
        )]
    ...
    public class RowCount : PipelineComponent
    {
        ...
        public override void PostExecute()
        {
            ...
            cmd.Parameters.Add(new SqlParameter("@ExecutionID", _executionId));
        ...
        public void LogRowCount()
        {
            ...
            _cmd.Parameters["@ExecutionID"].Value = _executionId;
        ...
        public override void PreExecute()
        {
            ...
            if (variables.Locked)
            {
                _executionId = (Int64)variables["User::ExecutionID"].Value;
                variables.Unlock();
            }
