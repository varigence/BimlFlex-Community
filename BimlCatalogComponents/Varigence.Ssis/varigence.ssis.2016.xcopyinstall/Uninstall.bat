...
del "C:\Program Files (x86)\Microsoft SQL Server\130\DTS\PipelineComponents\Varigence.Ssis.2016.dll" /F
del C:\Program Files\Microsoft SQL Server\130\DTS\PipelineComponents\Varigence.Ssis.2016.dll" /F
