...
del "C:\Program Files (x86)\Microsoft SQL Server\120\DTS\PipelineComponents\Varigence.Ssis.2014.dll" /F
del C:\Program Files\Microsoft SQL Server\120\DTS\PipelineComponents\Varigence.Ssis.2014.dll" /F
